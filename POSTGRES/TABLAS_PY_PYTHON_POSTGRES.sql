...
CIF VARCHAR(9) PRIMARY KEY CHECK (CIF ~ '^[A-Za-z][0-9]{8}$'),
COD_PE VARCHAR(10),
...
COD_CENTRALES VARCHAR(10) PRIMARY KEY CHECK (COD_CENTRALES ~ '^[A-Za-z]@[0-9]{3}-[A-Z]$'),
CIF VARCHAR(9),
FECHA_CE DATE,
UBICACION VARCHAR(20) CHECK (UBICACION NOT IN ('MADRID')),
CAPACIDAD_MAX NUMERIC(6) CHECK (CAPACIDAD_MAX > 0),
CONSTRAINT CIF_FK FOREIGN KEY (CIF) REFERENCES EMPRESA(CIF),
CONSTRAINT UBI_AJENA UNIQUE(UBICACION)
);

CREATE TABLE HIDROELECTRICA (
COD_H VARCHAR(10) PRIMARY KEY,
COD_CENTRALES VARCHAR(10),
CONSTRAINT CENTH_FK FOREIGN KEY (COD_CENTRALES) REFERENCES CENTRALES(COD_CENTRALES)
);

CREATE TABLE SOLAR (
COD_S VARCHAR(10) PRIMARY KEY,
COD_CENTRALES VARCHAR(10),
TIPO_S VARCHAR(15) CHECK (TIPO_S IN ('FOTOVOLTAICA', 'TERMODINAMICA')),
SUPERFICIE_TOTAL_PANALES NUMERIC(10) CHECK (SUPERFICIE_TOTAL_PANALES BETWEEN 0 AND 1000),
MED_ANUAL_H_SOL NUMERIC(2) CHECK (MED_ANUAL_H_SOL >= 0),
CONSTRAINT CENTS_FK FOREIGN KEY (COD_CENTRALES) REFERENCES CENTRALES(COD_CENTRALES)
);

CREATE TABLE TERMICA (
COD_T VARCHAR(10) PRIMARY KEY,
COD_CENTRALES VARCHAR(10),
NUM_HORNOS NUMERIC(5) CHECK (NUM_HORNOS > 0),
VOLUMEN_CARBON_CONSUMIDO NUMERIC(7) CHECK (VOLUMEN_CARBON_CONSUMIDO >= 0),
CONSTRAINT CENTT_FK FOREIGN KEY (COD_CENTRALES) REFERENCES CENTRALES(COD_CENTRALES)
);

CREATE TABLE EOLICAS (
COD_EO VARCHAR(10) PRIMARY KEY,
COD_CENTRALES VARCHAR(10),
VELOCIDAD_MEDIA_VIENTO NUMERIC(6) CHECK (VELOCIDAD_MEDIA_VIENTO > 0),
...
INSERT INTO CENTRALES VALUES ('A@123-Z', 'A12345678', '2021-10-21', 'BARCELONA', 500);
INSERT INTO CENTRALES VALUES ('B@245-S', 'D12789012', '2021-02-11', 'VALENCIA', 600);
INSERT INTO CENTRALES VALUES ('G@433-F', 'G34345678', '2021-12-21', 'MALAGA', 700);
INSERT INTO CENTRALES VALUES ('T@113-X', 'J54901234', '2021-04-11', 'SEVILLA', 550);
INSERT INTO CENTRALES VALUES ('U@183-U', 'M23567890', '2021-05-08', 'GRANADA', 480);
INSERT INTO CENTRALES VALUES ('F@123-Z', 'F23567450', '2021-01-21', 'ALMERIA', 300);
INSERT INTO CENTRALES VALUES ('Y@245-S', 'K25523840', '2021-05-11', 'CADIZ', 200);
INSERT INTO CENTRALES VALUES ('S@433-F', 'L23236850', '2021-11-21', 'CORDOBA', 730);
INSERT INTO CENTRALES VALUES ('O@323-G', 'P24367320', '2021-06-11', 'JAEN', 526);
INSERT INTO CENTRALES VALUES ('Z@183-S', 'R22367890', '2021-07-08', 'BILBAO', 800);
INSERT INTO CENTRALES VALUES ('G@183-S', 'M23567890', '2021-07-08', 'RIOJA', 600);
INSERT INTO CENTRALES VALUES ('E@111-A', 'E12345678', '2021-07-08', 'CACERES', 800);
INSERT INTO CENTRALES VALUES ('C@666-D','P19293949','2021-02-08','UTRERA',500);
