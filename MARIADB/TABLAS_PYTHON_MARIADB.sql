...
CIF VARCHAR(9) PRIMARY KEY CHECK (CIF REGEXP '^[A-Za-z][0-9]{8}$'),
COD_PE VARCHAR(10),
...
COD_CENTRALES VARCHAR(10) PRIMARY KEY CHECK (COD_CENTRALES REGEXP
'^[A-Za-z]@[0-9]{3}-[A-Z]$'),
CIF VARCHAR(9),
FECHA_CE DATE,
UBICACION VARCHAR(20) CHECK (UBICACION NOT IN ('MADRID')),
CAPACIDAD_MAX INT(6) CHECK (CAPACIDAD_MAX > 0),
...
SUPERFICIE_TOTAL_PANALES INT(10) CHECK (SUPERFICIE_TOTAL_PANALES BETWEEN 0 AND 1000),
MED_ANUAL_H_SOL INT(2) CHECK (MED_ANUAL_H_SOL >= 0),
...
COD_CENTRALES VARCHAR(10),
NUM_HORNOS INT(5) CHECK (NUM_HORNOS > 0),
VOLUMEN_CARBON_CONSUMIDO INT(7) CHECK (VOLUMEN_CARBON_CONSUMIDO >= 0),
...
COD_CENTRALES VARCHAR(10),
VELOCIDAD_MEDIA_VIENTO INT(6) CHECK (VELOCIDAD_MEDIA_VIENTO > 0),
